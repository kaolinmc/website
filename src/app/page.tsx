        ...
        <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <FeatureCard icon={
                    ...
                    Built from the ground up in Kotlin, safe asynchronous code decreases wait times for developers and users.
                </FeatureCard>
                <FeatureCard icon={
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-8">
                    ...
                    No longer worry about dependencies, Kaolin handles all dependency management for you.
                </FeatureCard>
                <FeatureCard icon={
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-8">
                    ...
                    Kaolin extensions are by nature small, fast, and fully reloadable with hotswap mixins even during production.
                </FeatureCard>
                <FeatureCard icon={
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-8">
                ...
                } title="Easy to Use and Safe">
                    Simplify and maintain support for various Minecraft versions easily through the Partition API.
                </FeatureCard>
            </div>
        </div>
    </section>
        ...
        <div className="container mx-auto px-6">
            ...
            <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                ...
                <GetStartedStep number="3" title="Develop!">
                   Begin developing with nothing in between you and your ideas
                </GetStartedStep>
            </div>
        </div>
    </section>
